...
Lister-плагін для Total Commander для перегляду і редагування файлів налаштувань. 
(`*.ini, *.inf, *.reg`). У порівнянні з текстовими редакторами з підсвічуванням синтаксису 
відрізняється зручністю редагування і високою швидкістю роботи з великими файлами.

**Завантажити:** [wlx_inied_2.0.7z](https://stayathome.github.io/files/wlx_inied_2.0.7z)

_Мінімальні вимоги:_ Total Commander 5.51
